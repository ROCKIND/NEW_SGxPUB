...
Cᴀꜱᴇ ᴏғ ᴄᴏᴘʏʀɪɢʜᴛ ᴅɪʀᴇᴄᴛ ᴛᴀʟᴋ : [YᴏᴜʀSᴇʟғ](tg://settings)"""
    ...
    DS_TEXT  = """<b>𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓𝐨 𝐌𝐨𝐯𝐢𝐞𝐬 𝐏𝐫𝐞𝐦𝐢𝐮𝐦 𝐙𝐨𝐧𝐞🔥</b>

<b>Bᴇɴᴇғɪᴛs ᴏғ ʙᴜʏɪɴɢ ᴏᴜʀ ᴘʀᴇᴍɪᴜᴍ ᴘʟᴀɴs:

⇒ Nᴏ ɴᴇᴇᴅ ᴛᴏ ᴏᴘᴇɴ Sʜᴏʀᴛʟɪɴᴋ.
...
<b><blockquote>𝐂𝐨𝐧𝐭𝐚𝐜𝐭 𝐓𝐨 𝐁𝐮𝐲: 👉🏻 @Developer_DM_Bot 👈🏻</blockquote></b>"""
...
<blockquote>🔋 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='https://t.me/Developer_DM_Bot'>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a></blockquote></b>"""
...
⚠ I Wɪʟʟ Gɪᴠᴇ Yᴏᴜ Oɴʟʏ Tʜᴇᴀᴛʀᴇ Pʀɪɴᴛ Oʀ Nᴇᴡ Rᴇʟᴇꜱᴇᴅ Mᴏᴠɪᴇꜱ ⚠
...
USE 👉🏻 @Movie_4_All_Bot For All Other Movies !
</b>"""
